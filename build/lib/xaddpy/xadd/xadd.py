...
class XADD:
    ...
    def evaluate_decision(
        ...
        # Inequality decision
            ...
            #####################
            ### quick fix need to look at later
            var_list = list(var_set)
            var_dict = {str(v):v for v in var_list}
            new_cont_assign = {}
            for k, v in cont_assign.items():
                if str(k) in var_dict.keys():
                    new_k =  var_dict[str(k)]
                else:
                    new_k = k
                new_cont_assign[new_k] = v
            cont_assign = new_cont_assign
